    ...
    if (res.code == "200") {
      ...
      setState(() {
        ...
        _polygonGeofenceCursorMarkers = newList.asMap().entries.map((entry) {
          ...
          // Thay thế mũi tên xoay bằng biểu tượng cây xăng hoặc trạm sạc
          return Marker(
            width: 40.0,
            height: 40.0,
            point: point,
            builder: (ctx) {
              // Biểu tượng cây xăng hoặc trạm sạc (icon bạn muốn thay thế)
              return Image.asset(
                "assets/images/fuel-station-icon.png", // Thay đổi theo tên icon bạn có
                width: 30.0,
                height: 30.0,
              );
            },
