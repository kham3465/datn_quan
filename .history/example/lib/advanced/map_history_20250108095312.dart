...
class MapHistory extends StatefulWidget {
  ...
  const MapHistory( {super.key, required this.idShip, required this.createTime, required this.endTime});
  @override
...
Future<void> getLocation() async {
  final res = await ApiRequest.getLocation(widget.idShip, widget.createTime, widget.endTime);
