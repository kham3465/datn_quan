...
class MapNewState extends State<MapNew>
  ...
  Future<void> getLocation() async {
    ...
    Timer.periodic(Duration(seconds: 3), (timer) async {
      ...
      if (res.code == "200") {
        ...
        setState(() {
          _polygonGeofenceCursorPoint = newList;
          _moveToFirstPoint(_polygonGeofenceCursorPoint);
        });
      } else {
        print("Thất bại");
      }
  ...
  List<LatLng> _polygonGeofenceCursorPoints = [];
   List<LatLng> _polygonGeofenceCursorPoint = [];
          ...
          child: FlutterMap(
            ...
            PolygonLayer(polygons: [
              Polygon(
                  ...
                  color: Colors.blue.withOpacity(0.2),
                  isFilled: true,
                  points: _polygonGeofenceCursorPoint)
            ]),
