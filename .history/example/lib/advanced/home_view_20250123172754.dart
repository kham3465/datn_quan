...
import 'package:flutter_background_geolocation_example/view/screens/queue/create_queue.dart';
...
class HomeViewState extends State<HomeView>
  ...
  Future<void> _showMarkerDialog(BuildContext context, ElectricVehicle vehicle) async {
 final SharedPreferences prefs = await SharedPreferences.getInstance();
      int await prefs.getInt('idUser');
