...
Future<void> getLocation() async {
  ...
  if (res.code == "200") {
    ...
    setState(() {
      _polygonGeofenceCursorPoints = newList;
       _moveToFirstPoint(_polygonGeofenceCursorPoints);
    });
  } else {
    print("Thất bại");
  }
...
void _moveToFirstPoint(List<LatLng> points) {
  if (points.isNotEmpty) {
    ...
    _mapController.move(firstPoint, 14.0); // 14.0 là mức zoom, bạn có thể thay đổi
  }
}
  @override
