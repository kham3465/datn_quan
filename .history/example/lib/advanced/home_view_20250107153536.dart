...
import 'package:flutter_background_geolocation_example/advanced/mapship_detail.dart';
...
class HomeViewState extends State<HomeView> with TickerProviderStateMixin<HomeView>, WidgetsBindingObserver {
 ...
 final userProvider = Provider.of<UserProvider>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title: const Text('Bản đồ đường biển'),
          centerTitle: true,
