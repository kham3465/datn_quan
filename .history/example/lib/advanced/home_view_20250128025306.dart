...
import 'package:flutter_background_geolocation_example/view/screens/electric/electric.dart';
...
class HomeViewState extends State<HomeView>
              ...
              child: MouseRegion(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(
                        height: 5.0), // Khoảng cách giữa icon và text
                    Text(
                      vehicle.name,
  ...
  Future<void> _showMarkerDialog(
    BuildContext context, ElectricVehicle vehicle) async {
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        ...
        content: Column(
          ...
          actionsAlignment: MainAxisAlignment.center, // Căn giữa hàng nút
          actions: [
            Row(
              mainAxisAlignment: MainAxisAlignment.center, // Căn giữa nút
              children: [
                TextButton(
                  onPressed: () {
                    print("Đăng ký");
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) => RegisterView(
                              idUser: idUser ?? 1, idVehicle: vehicle.id)),
                    );
                  },
