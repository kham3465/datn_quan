    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            SizedBox(height: 20),
            // Sử dụng Row để hiển thị 2 khung chọn ngang
            Row(
              ...
              children: [
                Expanded(
                  child: ElevatedButton(
                    ...
                    child: Text(
                      startDate != null
                          ? 'Bắt đầu: ${startDate!.toIso8601String().split('T')[0]} ${startDate!.hour}:${startDate!.minute}'
                ...
                Expanded(
                  child: ElevatedButton(
                    ...
                    child: Text(
                      endDate != null
                          ? 'Kết thúc: ${endDate!.toIso8601String().split('T')[0]} ${endDate!.hour}:${endDate!.minute}'
