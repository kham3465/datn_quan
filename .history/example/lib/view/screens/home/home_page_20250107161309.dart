...
import 'package:flutter_background_geolocation_example/view/screens/device/device.dart';
              ...
              InkWell(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => UserListScreenSailor(),
                    ),
                  );
                },
                child: ChildMenu(
                  image: AppImages.sailor,
                  label: "Thủy thủ",
                ),
              ),
            if (role != 'SERVICE')
