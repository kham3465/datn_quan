...
class _HomeMapState extends State<HomeMap> {
  ...
  Future<void> initData() async {
    ...
    setState(() {
      data = (res.data as List).map((item) => ElectricVehicle.fromJson(item)).toList();
    });
  }
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return ListTile(
              ...
              subtitle: Text('Vĩ độ: ${vehicle.latitude}, Kinh độ: ${vehicle.longitude}'),
              onTap: () {
                // Xử lý khi nhấn vào trạm sạc
              },
            );
          },
        ),
