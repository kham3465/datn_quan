...
class _RegisterViewState extends State<RegisterView> {
 ...
 Future<void> createQueue(int idUser, int idVehicle, String number, BuildContext context) async {
  ...
  if (res.code == "200") {
    showSuccessDialog(
     ...
     showSuccessDialog(
      ...
      Icons.error_outline,
      const Color.fromARGB(255, 194, 48, 4),
    );
  }
}

void showSuccessDialog(
    BuildContext context, String head, String content, IconData icon, Color iconColor) {
  showDialog(
    context: context,
      ...
      return AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            Icon(
              icon,
              color: iconColor, // Use the provided icon color here too
              size: 40,
            ),
          ],
        ),
