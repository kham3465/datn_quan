...
class RegisterView extends StatefulWidget {
  ...
  const RegisterView({super.key, required this.idUser, required this.idVehicle});
  @override
...
class _RegisterViewState extends State<RegisterView> {
  ...
  Future<void> createQueue(int idUser, int idVehicle, String number) async {
    ...
    if (res.code == "200") {
      showSuccessDialog(context, "Thành công", " Đăng ký thành công lịch", Icon(
      ...
      showSuccessDialog(
          context, "Thất bại", "Trạm sạc đang bận, không thể đăng ký được",Icon(
                Icons.check_circle_outline,
                color: Colors.green,
                size: 30,
              ));
  ...
  void showSuccessDialog(BuildContext context, String head, String content, Icon icon) {
    showDialog(
      context: context,
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildChargingSlot(
              slotNumber: "Ô Số 1",
              onTap: () => _showRegisterDialog("Ô Số 1","ONE"),
              icon: Icons.ev_station,
            ),
            SizedBox(height: 20),
            _buildChargingSlot(
              slotNumber: "Ô Số 2",
              onTap: () => _showRegisterDialog("Ô Số 2","TWO"),
              icon: Icons.ev_station,
            ),
            SizedBox(height: 20),
            _buildChargingSlot(
              slotNumber: "Ô Số 3",
              onTap: () => _showRegisterDialog("Ô Số 3","THREE"),
              icon: Icons.ev_station,
            ),
          ],
        ),
