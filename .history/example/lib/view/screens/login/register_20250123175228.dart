...
class RegisterScreenState extends BaseState<RegisterScreen> {
  ...
  Future<void> _submitRegistration() async {
    if (_formKey.currentState!.validate()) {
      ...
      final res = await ApiRequest.userRegister(name, numberCar, password);
      if (res.code == "200") {
        _showSuccessDialog();
      } else {}
    }
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Center(
                        child: SimpleButton(
                          titleButton: "Đăng ký",
                          colorButton: Color.fromARGB(255, 3, 138, 161),
            ...
            TextButton(
              onPressed: () {
                Navigator.pushNamed(context,
                    AppRoutes.loginScreen); // Điều hướng tới màn hình đăng ký
              },
              child: Text(
                "Đăng nhập",
                style: TextStyle(
                  color: Color.fromRGBO(11, 124, 199, 1), // Màu sắc của chữ
                  fontSize: 16,
