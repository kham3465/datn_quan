...
import 'package:flutter_background_geolocation_example/view/model/user_model.dart';
...
import 'package:flutter_background_geolocation_example/view/utils/widget/app_functions.dart';
...
class LoginScreenState extends BaseState<LoginScreen> with BaseScreenMixin {
  ...
  final res = await ApiRequest.userLogin(phone, pass);
  
  if (res.code == "200" && context.mounted) {
    print(res);
    userProvider.setUser(UserModel.fromJson(res.data));
    Navigator.pushNamed(context, AppRoutes.home);
    void showSuccessDialog(BuildContext context) {
  showDialog(
    context: context,
    barrierDismissible: false, // Ngăn chặn việc đóng hộp thoại khi nhấn ra bên ngoài
